...
window.addEventListener("DOMContentLoaded", function (e) {
  ...
  t(window).on("scroll", function (e) {
    0 == t(window).scrollTop() ? t("#header-container").removeClass() : t("#header-container").addClass("scrolled");
  });
}), jQuery(document).ready(function (e) {
  e("ul.menu.ui-sortable li.menu-item-depth-0").each(function () {
    e(this).next().hasClass("menu-item-depth-1") && e(this).find(".menu-item-settings .acf-menu-item-fields .acf-field-true-false").each(function () {
      "menu_cta_button" == e(this).attr("data-name") && e(this).hide();
    });
  });
});
/******/ })()
