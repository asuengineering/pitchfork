...
if ( ! class_exists( 'nextlevel_acf_field_menu' ) ) :
	class nextlevel_acf_field_menu extends acf_field {
		...
		public static $test = 'Engineering is amazing';

		/** @var array plugin settings (url, path, version) */
		public $settings = [];

		/** @var string sentinel string for default menu value */
		public $default_sentinel = 'acf-field-menu-v5-default';
		...
		// initialize
		new nextlevel_acf_field_menu( [
			'version' => '1.0.0',
			'url'     => get_template_directory_uri() . '/inc/acf-menu-select/',
			'path'    => get_template_directory() . '/inc/acf-menu-select/',
		] );
